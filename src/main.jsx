...
function App(){
 ...
 return <div className="app">
  <header><div><small>SOUND BOX PROJECT</small><h1>Hardware Dashboard</h1><p>Live ESP32 temperature and humidity data</p></div><button onClick={load} disabled={loading}>{loading?"Loading...":"Refresh"}</button></header>
